...
<Project Type="Project" LVVersion="15008000">
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="Label Targets2.vi" Type="VI" URL="../../C/Program Files (x86)/National Instruments/LabVIEW 2015/examples/FRC/roboRIO/Vision/2016 Vision Example/Vision Support Code/Label Targets2.vi"/>
			<Item Name="Camera Types.ctl" Type="VI" URL="../../C/Program Files (x86)/National Instruments/LabVIEW 2015/examples/FRC/roboRIO/Vision/2016 Vision Example/Vision Support Code/Camera Types.ctl"/>
			<Item Name="Get camera FOVs.vi" Type="VI" URL="../../C/Program Files (x86)/National Instruments/LabVIEW 2015/examples/FRC/roboRIO/Vision/2016 Vision Example/Vision Support Code/Get camera FOVs.vi"/>
			<Item Name="Compute DistanceToTarget2.vi" Type="VI" URL="../../C/Program Files (x86)/National Instruments/LabVIEW 2015/examples/FRC/roboRIO/Vision/2016 Vision Example/Vision Support Code/Compute DistanceToTarget2.vi"/>
			<Item Name="Normalize Coordinates.vi" Type="VI" URL="../../C/Program Files (x86)/National Instruments/LabVIEW 2015/examples/FRC/roboRIO/Vision/2016 Vision Example/Vision Support Code/Normalize Coordinates.vi"/>
			<Item Name="Normalized Range Compare 2016.vi" Type="VI" URL="../../C/Program Files (x86)/National Instruments/LabVIEW 2015/examples/FRC/roboRIO/Vision/2016 Vision Example/Vision Support Code/Normalized Range Compare 2016.vi"/>
			<Item Name="Normalize Score.vi" Type="VI" URL="../../C/Program Files (x86)/National Instruments/LabVIEW 2015/examples/FRC/roboRIO/Vision/2016 Vision Example/Vision Support Code/Normalize Score.vi"/>
			<Item Name="Aspect Ratio Score 2016.vi" Type="VI" URL="../../C/Program Files (x86)/National Instruments/LabVIEW 2015/examples/FRC/roboRIO/Vision/2016 Vision Example/Vision Support Code/Aspect Ratio Score 2016.vi"/>
			<Item Name="Area Scoring.vi" Type="VI" URL="../../C/Program Files (x86)/National Instruments/LabVIEW 2015/examples/FRC/roboRIO/Vision/2016 Vision Example/Vision Support Code/Area Scoring.vi"/>
			<Item Name="Moment Score.vi" Type="VI" URL="../../C/Program Files (x86)/National Instruments/LabVIEW 2015/examples/FRC/roboRIO/Vision/2016 Vision Example/Vision Support Code/Moment Score.vi"/>
			<Item Name="Calculate Particle Scores.vi" Type="VI" URL="../../C/Program Files (x86)/National Instruments/LabVIEW 2015/examples/FRC/roboRIO/Vision/2016 Vision Example/Vision Support Code/Calculate Particle Scores.vi"/>
			<Item Name="Sorted Particle Report 2016.vi" Type="VI" URL="../../C/Program Files (x86)/National Instruments/LabVIEW 2015/examples/FRC/roboRIO/Vision/2016 Vision Example/Vision Support Code/Sorted Particle Report 2016.vi"/>
			<Item Name="Calibration Helper2.vi" Type="VI" URL="../../C/Program Files (x86)/National Instruments/LabVIEW 2015/examples/FRC/roboRIO/Vision/2016 Vision Example/Vision Support Code/Calibration Helper2.vi"/>
		...
		<Item Name="Build Specifications" Type="Build">
			<Item Name="FRC_Dashboard" Type="EXE">
				...
				<Property Name="Source[0].itemID" Type="Str">{B7B6D6D9-8E89-4E7D-B5D1-16F57FF3E4D5}</Property>
